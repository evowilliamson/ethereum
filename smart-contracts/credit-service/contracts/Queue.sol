...
/**
 * Library that implements a queue (FIFO) of bytes32 elements. 
...
library Queue {
    ...
    /**
     * Function to remove an element from the queue. It will run through the 
     * the whole list! 
     * 
     * If you are sure that the first element will be removed (after a peek), it's ok...
     */
